...
const autoMap = (headers) => {
  ...
  const aliases = {
    name: ['name', 'nom', 'nomcomplet', 'fullname', 'nomdel\'artiste', 'nomdelartiste', 'nomdulartiste', 'artiste'],
    first_name: ['firstname', 'prenom', 'givenname'],
    last_name: ['lastname', 'nomdefamille', 'surname'],
    stage_name: ['stagename', 'nomscene', 'pseudonyme', 'alias', 'nomdescene'],
    email: ['email', 'mail', 'courriel'],
    phone: ['phone', 'tel', 'telephone', 'mobile'],
    category: ['category', 'categorie', 'cat'],
    discipline: ['discipline', 'style', 'type'],
    photo_url: ['photourl', 'photo', 'image', 'photolink', 'photodrive', 'liendossierphoto', 'lienvideo', 'lienphoto'],
    short_bio: ['shortbio', 'biocourte', 'minibio', 'bio'],
    full_bio: ['fullbio', 'biocomplete', 'biographie', 'longbio', 'biocomplete'],
    ...
    youtube: ['youtube', 'yt'],
    linkedin: ['linkedin'],
    consent_diffusion: ['consentdiffusion', 'consent', 'consentement', 'diffusion', 'autorisationdiffusion'],
