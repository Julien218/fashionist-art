...
export default function ArtistDetail() {
  ...
  useEffect(() => {
    ...
    if (!id) navigate(createPageUrl('Artists'));
    setArtistId(id);
  }, [navigate]);
  ...
  return (
    <div className="py-12 px-4">
      <SEOHead pageName="Artists" title={`${artist.name} — ${artist.discipline} | Fashionist'ART 2026`} description={artist.short_bio || `${artist.name} participera à Fashionist'ART le 18 avril 2026 à Dour, Belgique. ${artist.discipline}. Entrée gratuite !`} image={artist.photo_url} />
      <div className="max-w-4xl mx-auto">
        {/* Back button */}
        <motion.button
