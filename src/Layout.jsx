...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white flex flex-col" style={{position:'relative'}}>
      ...
      {/* Header */}
      <header className="fixed top-[3px] left-0 right-0 z-40 bg-transparent">
      ...
      <footer className="relative z-10 border-t border-white/10 mt-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/25">
            ...
            <p>Développé par <span className="text-[#FF2D8A]">JY-Trix.AI</span> & <span className="text-[#FF2D8A]">Js-Innov.IA</span></p>
          </div>
        </div>
      </footer>
    </div>
