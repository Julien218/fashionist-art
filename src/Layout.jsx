        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/25">
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center sm:justify-end">
              ...
              <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69a460cb984c65f748b49e7d/323e03f0b_LOGO_JY-TrixIA.jpg" alt="JY-Trix.AI" className="h-20 object-contain hover:opacity-100 transition-opacity" style={{mixBlendMode:'screen', opacity:0.9}} />
